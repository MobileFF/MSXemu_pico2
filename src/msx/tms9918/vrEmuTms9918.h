...
/* Function:  vrEmuTms9918VramPtr
 * ----------------------------------------
 * direct pointer to the internal 16KB VRAM buffer, for bulk save/restore
 * (e.g. save-state) without a byte-at-a-time copy loop. Valid for the
 * lifetime of tms9918.
 */
VR_EMU_TMS9918_DLLEXPORT
uint8_t* vrEmuTms9918VramPtr(VrEmuTms9918* tms9918);
